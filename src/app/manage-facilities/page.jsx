    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const res = await fetch(
                `${apiUrl}/facility/${editingFacility._id}`,
                {
                    method: "PUT",
                    headers: {
            ...
            setFacilities((prev) =>
                prev.map((facility) =>
                    facility._id === editingFacility._id
                        ? {
                              ...facility,
                              ...updatedFacility,
                          }
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 mt-2">
                            Manage all arenas you listed.
                            Edit details, time slots,
                ...
                {facilities.length === 0 ? (
                    <div className="bg-white rounded-3xl p-12 text-center border border-gray-100 shadow-sm max-w-lg mx-auto">
                        ...
                        <p className="text-gray-500 mt-2 mb-6">
                            You havent listed any sports facilities yet.
                        </p>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="flex flex-wrap gap-1.5 max-h-20 overflow-y-auto">
                                                {fac.available_slots &&
                                                fac.available_slots.length > 0 ? (
                                                    fac.available_slots.map(
                                                        (s, idx) => (
                                                            <span
                                                                key={idx}
                                                                className="bg-gray-100 text-gray-600 text-[10px] font-semibold px-2 py-1 rounded-md"
                                                            >
                                                                {s}
                                                            </span>
                                                        )
                            ...
                            >
                                ...
                                <div className="flex gap-4 justify-end pt-4 border-t border-gray-100">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isUpdating}
                                        className={`bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 py-3 rounded-xl transition cursor-pointer text-xs uppercase shadow-md shadow-orange-500/10 ${
                                            isUpdating
                                                ? "opacity-50"
                                                : ""
                                        }`}
